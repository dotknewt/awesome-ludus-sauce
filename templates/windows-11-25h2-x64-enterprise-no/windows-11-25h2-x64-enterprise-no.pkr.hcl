...
variable "vm_name" {
  type    = string
  default = "windows-11-25h2-x64-enterprise-no-template"
}
...
locals {
 ...
 source "proxmox-iso" "windows-11-25h2-x64-enterprise-no" {
...
build {
  sources = ["source.proxmox-iso.windows-11-25h2-x64-enterprise-no"]

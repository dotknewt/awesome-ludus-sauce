...
variable "vm_name" {
  type    = string
  default = "windows-server-2025-x64-tpm-no-template"
}
...
locals {
 ...
 source "proxmox-iso" "windows-server-2025-x64-tpm-no" {
...
build {
  sources = ["source.proxmox-iso.windows-server-2025-x64-tpm-no"]
